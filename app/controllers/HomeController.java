...
//            userForm.fill(p);
    ...
    public Result updateReturn(Long id){
        ...
        //increaseStock = product.setStock(product.getStock() + 1);
        ...
        try{
            ...
            product.setStock(product.getStock()+1);// This is increasing the stock to one
            System.out.println(product.getStock());
            ul.update();
            product.update();//Updating the stock column after increasing it by 1 in the database

            //the method below dont even know why its there
            //product.increaseStock();//i made a method to increase the stock by one but doesn't work.
